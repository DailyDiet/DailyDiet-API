...
def sevade(list1, list2, list3, calorie):
    ...
    j = 0
    k = len(list3)-1
    print(list1[i].get_calorie(), list2[j].get_calorie(), list3[k].get_calorie())
    print(type(list1[i].get_calorie()))
    print(list1[i].get_calorie() + list2[j].get_calorie() + list3[k].get_calorie())
    print(type(list1[i].get_calorie() + list2[j].get_calorie() + list3[k].get_calorie()))
